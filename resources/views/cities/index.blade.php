...
@section('content')
    ...
    <div class="card p-0">
        ...
        <div class="card-header">
            <form method="GET" action="{{ route('cities.index') }}" class="row gy-2 gx-3 align-items-center d-inline-flex">
                <div class="col-auto">
                  <label class="visually-hidden" for="autoSizingInput">Search</label>
                  <input type="search" name="search" class="form-control" id="autoSizingInput" placeholder="Name or State Code">
                </div>
                <div class="col-auto">
